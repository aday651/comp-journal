...
- From the ACS data, get the median income of those who are moving
inside different census tracts from within the state as compared to
outside of the state for the ARC counties.
- For the income plots above, do the same rebinning as what was
done to create the migration plots.
- Areas of interest from the extremes map:
